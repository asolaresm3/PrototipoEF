...
{
    public partial class Frm_Consulta_Producto : Form
    {
        ...
        {
            OdbcDataReader mostrar = logic.consultarProductos();
            try
            {
                while (mostrar.Read())
                {
        ...
        private void Frm_Consulta_Producto_Load(object sender, EventArgs e)
        {
            Dgv_consulta.Rows.Clear();
            MostrarConsulta();
        }
