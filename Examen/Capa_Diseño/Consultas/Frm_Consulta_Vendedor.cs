...
{
    public partial class Frm_Consulta_Vendedor : Form
    {
        Logica logic = new Logica();
        public Frm_Consulta_Vendedor()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader mostrar = logic.consultarVendedor();
            try
            {
                while (mostrar.Read())
                {
        ...
        private void Frm_Consulta_Vendedor_Load(object sender, EventArgs e)
        {
            Dgv_consulta.Rows.Clear();
            MostrarConsulta();
        }
