...
{
    public partial class Frm_Mantenimiento_Lineas : Form
    {
        Logica logic = new Logica();
        string scampo;
        public Frm_Mantenimiento_Lineas()
        {
            InitializeComponent();
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { textBox1, textBox2 };
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "lineas", textBox1.Text, textBox2.Text, comboBox1.Text };
                string[] campos = { "codigo_linea", "nombre_linea", "estado" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "marcas", textBox1.Text, "codigo_marca" };
        ...
        {
            Frn_Consulta_Linea linea = new Frn_Consulta_Linea();
            linea.ShowDialog();

            if (linea.DialogResult == DialogResult.OK)
            {
                textBox1.Text = linea.Dgv_consulta.Rows[linea.Dgv_consulta.CurrentRow.Index].
                      Cells[0].Value.ToString();
                textBox2.Text = linea.Dgv_consulta.Rows[linea.Dgv_consulta.CurrentRow.Index].
