...
{
    public partial class Frm_Mantenimiento_Marca : Form
    {
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "marcas", textBox1.Text, textBox2.Text, comboBox1.Text };
                string[] campos = { "codigo_marca", "nombre_marca", "estado" };
        ...
        {
            Frm_Consulta_Marca marca = new Frm_Consulta_Marca();
            marca.ShowDialog();

            if (marca.DialogResult == DialogResult.OK)
            {
                textBox1.Text = marca.Dgv_consulta.Rows[marca.Dgv_consulta.CurrentRow.Index].
                      Cells[0].Value.ToString();
                textBox2.Text = marca.Dgv_consulta.Rows[marca.Dgv_consulta.CurrentRow.Index].
